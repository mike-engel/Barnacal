  ...
  render: fun _self => {
    ...
    <div style=header_styles>
      <a
        ...
        onClick=(self.ReasonReact.update onLastMonth)
      />
      <h1 style=header_text_styles onClick=(self.ReasonReact.update resetDate)>
      ...
      <a
        ...
        onClick=(self.ReasonReact.update onNextMonth)
      />
    </div>
  }
};
